export const siteConfig = {
  ...
  business: {
    ...
    categories: [
      ...
      "Agencia de viajes",
      "Agencia de turismo náutico",
      "Agencia de turismo",
    ],
    founded: "21 de enero de 2018",
    openingDate: "21 de enero de 2018",
    serviceAreas: ["Armação dos Búzios, RJ, Brasil"],
    languages: ["Portugués", "Español"],
    payments: ["Tarjeta de crédito", "Tarjeta de débito", "NFC", "VISA", "MasterCard", "American Express", "Efectivo"],
    accessibility: [
      "Entrada con acceso para silla de ruedas",
      "Espacio accesible para personas en silla de ruedas",
    ],
    planning: ["No se requiere cita"],
    audience: ["Casais", "Familias", "Grupos"],
  },
  hours: {
    monday: "09:00-21:00",
    tuesday: "Cerrada",
