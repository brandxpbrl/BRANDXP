          ...
          <div className="lg:col-span-3 min-h-[50vh] p-8 md:p-12 rounded-3xl bg-[#0b0c14]/20 border border-zinc-800/60 backdrop-blur-2xl relative">
            <AnimatePresence mode="wait">
              {activeSection === "manifesto" && (
                ...
                >
                  <div>
                    <h2 className="text-3xl font-bold text-white mb-2">Filosofía & Visión Fundacional</h2>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg font-bold text-emerald-400">Computador Cosmológico</h3>
