      ...
      <main className="px-4 py-5 sm:px-6">
        <section className="relative overflow-hidden rounded-[28px] border border-white/[0.07] bg-[#07101b]/55 px-5 py-10 sm:px-8 lg:px-10">
          ...
          <div className="relative grid gap-8 xl:grid-cols-[220px_minmax(0,1fr)_260px] xl:items-center">
            ...
            <div className="grid gap-2">{[['ARCHITECTURE','ONLINE','cyan'],['RUNTIME','OBSERVED','amber'],['EPISTEMIC','ENFORCED','fuchsia']].map(([k,v]) => <div key={k} className="rounded-xl border border-white/[0.07] bg-black/15 px-4 py-3"><p className="text-[9px] tracking-[0.16em] text-white/30">{k}</p><p className="mt-1 text-sm">{v}</p></div>)}</div>
          </div>
        </section>
