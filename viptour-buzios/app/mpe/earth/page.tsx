      ...
      <main className="px-4 py-5 sm:px-6">
        <section className="relative overflow-hidden rounded-[28px] border border-white/[0.07] bg-[#07101b]/55 p-6 sm:p-8">
          ...
          <div className="relative grid gap-8 xl:grid-cols-[minmax(0,1fr)_420px] xl:items-center">
            ...
            <div className="relative mx-auto grid h-64 w-64 place-items-center"><div className="absolute inset-0 rounded-full border border-cyan-300/10"/><div className="absolute inset-6 rounded-full border border-cyan-300/10"/><div className="absolute inset-12 rounded-full bg-[radial-gradient(circle_at_35%_30%,rgba(103,232,249,.30),rgba(37,99,235,.12)_38%,rgba(2,6,12,.8)_70%)] shadow-[0_0_80px_rgba(34,211,238,.12)]"/><div className="relative text-center"><p className="text-[9px] tracking-[0.2em] text-cyan-100/45">EARTH NODE</p><p className="mt-2 text-sm text-white/65">OBSERVED</p><p className="mt-1 text-[9px] text-white/25">no synthetic heartbeat</p></div></div>
          </div>
        </section>
