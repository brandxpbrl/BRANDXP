...
- Fecha de generacion: 2026-05-18T09:52:18
...
11. Apendice: visuales generados

---

# Brand Analysis

_Fuente: 05_ENTREGAS/brand_analysis.md_
...
_Fuente: 05_ENTREGAS/identity_patch.md_
...
## Diferenciacion
- Urgency: Alta
- Reason: Diferenciacion esta debil o poco visible en las fuentes actuales.
- Action: Convertir atributos genericos en codigos propietarios: rituales, lenguaje, visuales y experiencia.

## Potencia narrativa
- Urgency: Media
- Reason: Potencia narrativa existe, pero necesita mas precision para sostener decisiones.
- Action: Construir una narrativa con conflicto, transformacion, prueba y frase madre de marca.
...
_Fuente: 05_ENTREGAS/entity_bible.md_

# Entity Bible - Mau Viagens Tours
...
_Fuente: 05_ENTREGAS/visual_universe.md_

# Visual Universe - Mau Viagens Tours
...
_Fuente: 05_ENTREGAS/content_strategy.md_

# Content Strategy - Mau Viagens Tours
...
## Deseo
- Role: Convertir el destino o servicio en una experiencia deseable, no solo en itinerario.
- Formats: reel sensorial, story de experiencia, visual manifesto, secuencia de stories
...
_Fuente: 05_ENTREGAS/ai_prompts.md_

# AI Prompts - Mau Viagens Tours
...
_Fuente: 05_ENTREGAS/action_plan.md_
...
_Fuente: 05_ENTREGAS/brand_identity_board.md_

# Brand Identity Board - Mau Viagens Tours
...
Las fuentes muestran senales utiles, pero el sistema debe separar identidad, percepcion visual, narrativa y conversion para operar con precision.
...
_Fuente: 05_ENTREGAS/storytelling_strategy_board.md_

# Storytelling Strategy Board - Mau Viagens Tours
...
Build stories that make the brand easier to feel, trust, remember, and choose.

---

# Visual Universe Board

_Fuente: 05_ENTREGAS/visual_universe_board.md_

# Visual Universe Board - Mau Viagens Tours
...
A system that makes the brand feel recognizable before it is explained.
...
Create a visual world that can guide posts, reels, proposals, and client-facing assets.
